"""
--------------------------------------------------------------------------------------------
Extracted from msmtools to avoid creating an explicit dependency, and to allow for specifing 
an initial guess for the eigenvector in stationary_distribution_from_backward_iteration as 
an argument to the top level function stationary_distribution.
